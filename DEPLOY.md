...
- **OCI Object Storage** — compositions, assets, rendered MP4s
...
4. **OCI Object Storage** — create a bucket in the same region as your A1 instance. Generate an S3-compatible access key.
...
| `STORAGE_BUCKET` | Recommended | `hf-projects` |
| `STORAGE_ENDPOINT` | If STORAGE_BUCKET set | `https://namespace.compat.objectstorage.region.oraclecloud.com` |
| `STORAGE_REGION` | If STORAGE_BUCKET set | `us-ashburn-1` |
| `STORAGE_ACCESS_KEY_ID` | If STORAGE_BUCKET set | `ocid1.credential...` |
| `STORAGE_SECRET_ACCESS_KEY` | If STORAGE_BUCKET set | `xxxxx` |
| `STORAGE_PUBLIC_BASE_URL` | Optional | `https://objectstorage.region.oraclecloud.com/n/namespace/b/bucket/o/` |
...
Oracle A1 Worker ◄── reads jobs ─────────────── ┘
      ...
      ├── writes compositions + MP4s ──► OCI Object Storage
...
| OCI Object Storage | $0 (first 10 GB) |
